	...
	class Nav_Walker extends Walker_Nav_Menu {
		...
		public function __construct() {
  		...
  		public function start_lvl( &$output, $depth = 0, $args = null ) {
    		...
    		if ( isset( $args->has_dropdown ) && $args->has_dropdown ) {
      			// Get the icon
      			ob_start();
      			require get_theme_file_path( 'assets/svg/arrow-down.svg' );
      			$icon = ob_get_clean();
		 ...
		 */
  		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			$classes[] = 'keydesign-menu-item menu-item-' . $item->ID;
			$classes[] = 'nav-item';
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'sierra' ) . '">' . esc_html__( 'Add a menu', 'sierra' ) . '</a></li>';
			$fallback_output .= '</ul>';
